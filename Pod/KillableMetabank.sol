...
contract KillableMetabank {
    ...
    function handlePayment() public payable only_alive(){
    ...
    function allowAccumulate() public only_alive(){
        accumulateInterests[msg.sender] = true;
    }

    function disallowAccumulate() public only_alive(){
        accumulateInterests[msg.sender] = false;
    }

    function withdraw(uint256 value) public only_alive() {
    ...
    function settle() public only_alive(){
    ...
    function kill() public only_alive() {
        require(msg.sender == owner);
        killed = true;
        safebox.sendTo(owner, total);
    }
